                        ...
                        <div hidden id="upload_pic_form" class="chage_picture_hidden">
                          <form name="change_profile_pic" action="functions.php" method="post" enctype="multipart/form-data">
                           <h5 style="color:#337ab7; padding-bottom: 15px">Upload a new profile picture</h5>
                              ...
                              <div class="form-group">
                                <button type="submit" onclick="return validateImage()" name="upload" class="btn btn-success">Upload</button>
                              </div>
                              <div class="form-group">
                                <button type="button" onclick="close_form()" name="cancel" class="btn btn-danger">Cancel</button>
                              </div>
                            ...
                            <div class="panel panel-default post">
                              <div class="panel-body">
                                ...
                                while ($row = mysql_fetch_array($sql, MYSQL_NUM)) { 
                                  ...
                                  <div class="row">
                                   <div class="col-sm-2">
                                     <a href="view_profile.php?action=view&id=<?php echo $userId?>" class="post-avatar thumbnail"><img src="<?php echo $image?>"><div class="text-center"><?php echo $fullName ?></div></a>
                                   </div>
                                   <div class="col-sm-10">
                                     <div class="bubble">
                                       <div class="pointer">
...
<script>
  ...
  function validateImage(){
   var filename = document.forms["change_profile_pic"]["img[]"].value;
   if(filename == ""){
